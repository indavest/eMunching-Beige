...
@interface DealsViewController : UIViewController <PLSegmentViewDelegate,UITableViewDelegate,UITableViewDataSource,NSXMLParserDelegate,ImageDownloaderDelegate,UIScrollViewDelegate>
{    
